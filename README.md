...
3. **อินโดนีเซีย (Indonesia)** <ins>ไม่พบ</ins>ความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับปัจจัยใดๆ แม้ว่าค่า <code style="color : green">_spearman-rho_</code> จะค่อนข้างสูงสำหรับ GDP และ GDP ต่อหัว แต่ <code style="color : green">_p-value_</code> ยังสูงเกินกว่าจะสรุปว่า ข้อมูลมีความสัมพันธ์กัน <br>
...
6. **มาเลเซีย (Malaysia)** <ins>ไม่พบ</ins>ความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับปัจจัยใดๆ เพราะค่า <code style="color : green">_p-value_</code> สูงในทุกกรณี <br>
7. **ไทย (Thailand)** <ins>ไม่พบ</ins>ความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับปัจจัยใดๆ เพราะค่า <code style="color : green">_p-value_</code> สูงในทุกกรณี  <br>
>
