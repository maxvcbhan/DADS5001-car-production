## Mini Project  เรื่อง  การศึกษาความสัมพันธ์ระหว่างปัจจัยเศรษฐกิจและการผลิตรถยนต์สันดาปในภูมิภาคเอเชีย (ASIA)
...
> **Part 3: การศึกษาปัจจัยที่มีความสัมพันธ์กับการผลิตรถยนต์ในภูมิภาคเอเชีย (ASIA)** โดยศึกษาปัจจัยทางเศรษฐกิจที่มีผลต่อจำนวนการผลิตรถยนต์
...
<p align="center"> $${\color{#b4a19d}ตารางที่&nbsp;&nbsp;1&nbsp;&nbsp;รายชื่อประเทศที่เป็นฐานการผลิตรถยนต์ทั่วโลก}$$ <br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เมื่อการวิเคราะห์ข้อมูลการผลิตรถยนต์แยกตามภูมิภาค ตาม**กราฟที่ 2** พบว่า ความโดดเด่นของเอเชียในอุตสาหกรรมยานยนต์โลก โดยภูมิภาคเอเชียมีการผลิตรถยนต์เฉลี่ยสูงถึง 48.22 ล้านคันต่อปี คิดเป็น 55% ของการผลิตทั้งหมดทั่วโลก ขณะที่ภูมิภาคอเมริกา เป็นผู้ผลิตอันดับสอง มีการผลิตเฉลี่ยอยู่ที่ 19.11 ล้านคันต่อปี ความแตกต่างนี้ชี้ให้เห็นว่า ภูมิภาคเอเชียมีกำลังการผลิตรถยนต์สันดาป มากกว่าภูมิภาคอเมริกาถึงเกือบ 2.5 เท่า
...
### Part 3: การศึกษาปัจจัยที่มีความสัมพันธ์กับการผลิตรถยนต์ในภูมิภาคเอเชีย (ASIA)
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
ในส่วนนี้จะทำการศึกษาปัจจัยทางเศรษฐกิจแต่ละประเทศที่อาจส่งผลต่อจำนวนการผลิตรถยนต์ในภูมิภาคเอเชีย โดยพิจารณาปัจจัยสำคัญ 3 ประการและเหตุผล ดังนี้
1. จำนวนประชากร (**Population**): วัดเป็นจำนวนคนในแต่ละประเทศ สะท้อนถึงขนาดตลาดผู้บริโภคที่อาจต้องการรถยนต์และแรงงานที่มีศักยภาพในอุตสาหกรรมยานยนต์ 
2. ผลิตภัณฑ์มวลรวมภายในประเทศ (**GDP**: Gross Domestic Product (**US$**)): เป็นตัวชี้วัดมูลค่าตลาดรวมของสินค้าและบริการขั้นสุดท้ายที่ผลิตในประเทศในช่วงเวลาหนึ่ง สะท้อนขนาดและความแข็งแกร่งของเศรษฐกิจโดยรวม ซึ่งมีผลต่อกำลังซื้อและความต้องการรถยนต์
3. ผลิตภัณฑ์มวลรวมภายในประเทศต่อหัว (**GDP per capita** (**US$**)): คำนวณจาก GDP หารด้วยจำนวนประชากร แสดงถึงระดับรายได้เฉลี่ยต่อคนและมาตรฐานการครองชีพของประชากรในประเทศนั้นๆ บ่งชี้ความสามารถในการซื้อรถยนต์ของประชาชน

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จาก**ตารางที่ 3** แสดงผลการวิเคราะห์ความสัมพันธ์ระหว่างจำนวนการผลิตรถยนต์กับทั้ง 3  ปัจจัยในแต่ละประเทศของภูมิภาคเอเชีย โดยใช้วิธีการทดสอบ Spearman's rank correlation (ทั้งนี้ เหตุผลในการเลือกใช้วิธีนี้เนื่องจากขนาดของกลุ่มตัวอย่างมีจำนวนน้อย (น้อยกว่า 30) และข้อมูลไม่มีการแจกแจงแบบปกติ)  สำหรับเกณฑ์การพิจารณาความสัมพันธ์ระหว่างตัวแปร คือ หากค่า <code style="color : green">p-value</code> มากกว่า 0.05 แสดงว่าไม่มีความสัมพันธ์อย่างมีนัยสำคัญทางสถิติระหว่างตัวแปรที่ทดสอบ ผลดังนี้ 
>
![image](figure/output_spearman_test.png)

<p align="center"> ตารางที่ 3 การวิเคราะห์ความสัมพันธ์ระหว่างจำนวนการผลิตรถยนต์กับปัจจัยทางเศรษฐกิจ ได้แก่ ประชากร(คน), GDP(US$) และ GDP ต่อหัว(US$)

1. **จีน (China)** <ins>ไม่พบ</ins>ความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับจำนวนประชากร GDP และ GDP ต่อหัว <br>
2. **อินเดีย (India)** พบความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับ GDP และ GDP ต่อหัว ที่มีความสัมพันธ์เป็น $${\color{lightskyblue}บวก}$$ <code style="color : green">(_spearman-rho > 0_)</code> แสดงว่า เมื่อ GDP หรือ GDP ต่อหัวเพิ่มขึ้น ทำให้จำนวนการผลิตรถยนต์มีแนวโน้มเพิ่มขึ้นด้วย <br>
3. **อินโดนีเซีย (Indonesia)** <ins>ไม่พบ</ins>ความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับปัจจัยใดๆ แม้ว่าค่า <code style="color : green">_spearman-rho_</code> จะค่อนข้างสูงสำหรับ GDP และ GDP ต่อหัว แต่ <code style="color : green">p-value</code> ยังสูงเกินกว่าจะสรุปว่า ข้อมูลมีความสัมพันธ์กัน <br>
4. **ญี่ปุ่น (Japan)** พบความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับประชากร <code style="color : green">(_p-value = 0.0242 < 0.05_)</code> ที่มีความสัมพันธ์เป็น $${\color{lightskyblue}บวก}$$  <code style="color : green">(_spearman-rho = 0.7212_)</code> แสดงว่า เมื่อจำนวนประชากรเพิ่มขึ้น ทำให้จำนวนการผลิตรถยนต์มีแนวโน้มเพิ่มขึ้นด้วย แต่<ins>ไม่พบ</ins>ความสัมพันธ์ระหว่างจำนวนการผลิตรถยนต์กับ GDP หรือ GDP ต่อหัว <br>
5. **เกาหลีใต้ (South Korea)** พบความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับทุกปัจจัย <code style="color : green">(_p-value < 0.05 ทุกกรณี_)</code> และมีความสัมพันธ์เป็น $${\color{red}ลบ}$$  <code style="color : green">(_spearman-rho < 0_)</code> แสดงว่าเมื่อปัจจัยเหล่านี้เพิ่มขึ้น ทำให้จำนวนการผลิตรถยนต์มีแนวโน้มลดลง <br>
6. **มาเลเซีย (Malaysia)** <ins>ไม่พบ</ins>ความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับปัจจัยใดๆ เพราะค่า <code style="color : green">p-value</code> สูงในทุกกรณี <br>
7. **ไทย (Thailand)** <ins>ไม่พบ</ins>ความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับปัจจัยใดๆ เพราะค่า <code style="color : green">p-value</code> สูงในทุกกรณี  <br>
>
#### สรุปภาพรวมการวิเคราะห์ความสัมพันธ์ระหว่างการผลิตรถยนต์และปัจจัยทางเศรษฐกิจในภูมิภาคเอเชีย ดังนี้
>
**1. <ins>ความหลากหลายของรูปแบบความสัมพันธ์</ins>**   แต่ละประเทศในภูมิภาคเอเชียแสดงรูปแบบความสัมพันธ์ที่แตกต่างกัน สะท้อนถึงความซับซ้อนและความเฉพาะตัวของอุตสาหกรรมยานยนต์ในแต่ละประเทศ
>
**2. <ins>ประเทศที่แสดงความสัมพันธ์ชัดเจน</ins>**  คือ **อินเดียและเกาหลี** พบความสัมพันธ์ที่มีนัยสำคัญระหว่างการผลิตรถยนต์กับ GDP และ GDP ต่อหัว แต่ทิศทางความสัมพันธ์ของทั้งสองประเทศเป็นไปในทางตรงข้ามกัน และ**ญี่ปุ่น** เป็นประเทศเดียวที่แสดงความสัมพันธ์อย่างมีนัยสำคัญระหว่างการผลิตรถยนต์กับจำนวนประชากร
>
**3. <ins>ประเทศที่ไม่พบความสัมพันธ์ชัดเจนในภาพรวม</ins>**  คือ **จีน อินโดนีเซีย มาเลเซีย และไทย** ไม่แสดงความสัมพันธ์ที่ชัดเจนระหว่างการผลิตรถยนต์กับปัจจัยที่ศึกษาในระดับประเทศ
>
...
&nbsp;&nbsp;&nbsp;&nbsp;จากแผนภาพ Spearman Correlation Heatmap ของประเทศอินโดนีเซีย ผลการวิเคราะห์**ขนาดและทิศทาง**ความสัมพันธ์ในระดับ Group Segment ดังนี้
1. การผลิตรถยนต์โดยรวม (Car Production (All)) มีความสัมพันธ์เชิงบวกที่สูงกับการผลิต SUV ( $${\color{yellowgreen}0.77}$$  ) และรถที่ไม่ได้จำแนกประเภท (Unclassified) ( $${\color{yellowgreen}0.79}$$  ) และมีความสัมพันธ์เชิงบวกปานกลางกับ GDP ( $${\color{yellowgreen}0.52}$$  ) และ GDP per capita ( $${\color{yellowgreen}0.60}$$  )
2. การผลิตรถยนต์นั่งส่วนบุคคล (Car Production (Passenger)) มีความสัมพันธ์เชิงลบที่สูงมากกับประชากร ( $${\color{fuchsia}-0.87}$$  ), GDP ( $${\color{fuchsia}-0.78}$$  ) และ GDP per capita ( $${\color{fuchsia}-0.71}$$  ) แต่ไม่มีความสัมพันธ์ที่ชัดเจนกับการผลิตรถยนต์ประเภทอื่น
3. การผลิตรถ SUV (Car Production (SUV)) มีความสัมพันธ์เชิงบวกที่สูงมากกับ GDP ( $${\color{yellowgreen}0.85}$$  ) และ GDP per capita ( $${\color{yellowgreen}0.92}$$  ) และมีความสัมพันธ์เชิงบวกที่สูงกับประชากร ( $${\color{yellowgreen}0.78}$$  )
4. การผลิตรถ MPV (Car Production (MPV)) มีความสัมพันธ์เชิงบวกปานกลางกับการผลิตรถยนต์โดยรวม ( $${\color{yellowgreen}0.60}$$  ) แต่ไม่มีความสัมพันธ์ที่ชัดเจนกับปัจจัยทางเศรษฐกิจ
5. การผลิตรถที่ไม่ได้จำแนกประเภท (Car Production (Unclassified)) มีความสัมพันธ์เชิงบวกที่สูงกับการผลิตรถยนต์โดยรวม ( $${\color{yellowgreen}0.79}$$  ) การผลิตรถ SUV ( $${\color{yellowgreen}0.77}$$  ) และมีความสัมพันธ์เชิงบวกปานกลางกับ GDP per capita ( $${\color{yellowgreen}0.66}$$  )
6. ปัจจัยทางเศรษฐกิจ ได้แก่ ประชากร  GDP และ GDP per capita มีความสัมพันธ์เชิงบวกที่สูงมากระหว่างกัน ( $${\color{yellowgreen}0.95-0.99}$$  )

![image](figure/fig_heatmap_indonesia.PNG)
<p align="center"> รูปที่ 3 แผนภาพ heatmap แสดงความขนาดและทิศทางสัมพันธ์กันระหว่างปัจจัยต่างๆ ของประเทศอินโดนีเซีย ด้วยสถิติ Spearman <br>
...
-	_ไม่มีข้อมูลการผลิตรถกระบะในแผนภาพนี้ เพราะไม่มีการผลิต_

#### มาเลเซีย (Malaysia)

&nbsp;&nbsp;&nbsp;&nbsp;จากแผนภาพ Spearman Correlation Heatmap ของประเทศมาเลเซีย ผลการวิเคราะห์**ขนาดและทิศทาง**ความสัมพันธ์ในระดับ Group Segment ดังนี้
1. การผลิตรถยนต์โดยรวม (Car Production (All)) มีความสัมพันธ์เชิงบวกที่สูงมากกับการผลิตรถยนต์นั่งส่วนบุคคล ( $${\color{yellowgreen}0.92}$$  ) และรถที่ไม่ได้จำแนกประเภท ( $${\color{yellowgreen}0.90}$$  ) มีความสัมพันธ์เชิงบวกที่สูงกับการผลิตรถกระบะ ( $${\color{yellowgreen}0.75}$$  ) และ MPV ( $${\color{yellowgreen}0.78}$$  ) และมีความสัมพันธ์เชิงบวกปานกลางกับ GDP และ GDP per capita ( $${\color{yellowgreen}0.36}$$  )
2. การผลิตรถยนต์นั่งส่วนบุคคล (Car Production (Passenger)) มีความสัมพันธ์เชิงบวกที่สูงกับการผลิตรถกระบะ ( $${\color{yellowgreen}0.77}$$  ), MPV ( $${\color{yellowgreen}0.77}$$  ) และรถที่ไม่ได้จำแนกประเภท ( $${\color{yellowgreen}0.85}$$  ) แต่ไม่มีความสัมพันธ์ที่ชัดเจนกับปัจจัยทางเศรษฐกิจ
3. การผลิตรถ SUV (Car Production (SUV)) มีความสัมพันธ์เชิงบวกที่สูงมากกับประชากร ( $${\color{yellowgreen}0.95}$$  ), GDP ( $${\color{yellowgreen}0.87}$$  ) และ GDP per capita ( $${\color{yellowgreen}0.87}$$  ) และมีความสัมพันธ์เชิงลบเล็กน้อยกับการผลิตรถประเภทอื่น ๆ
4. การผลิตรถกระบะ (Car Production (Pickup)) มีความสัมพันธ์เชิงบวกที่สูงกับการผลิต MPV ( $${\color{yellowgreen}0.88}$$  ) และรถที่ไม่ได้จำแนกประเภท ( $${\color{yellowgreen}0.84}$$  ) แต่ไม่มีความสัมพันธ์ที่ชัดเจนกับปัจจัยทางเศรษฐกิจ
5. การผลิตรถ MPV (Car Production (MPV)) มีความสัมพันธ์เชิงบวกที่สูงกับการผลิตรถกระบะ ( $${\color{yellowgreen}0.88}$$  ) และรถที่ไม่ได้จำแนกประเภท ( $${\color{yellowgreen}0.90}$$  ) แต่ไม่มีความสัมพันธ์ที่ชัดเจนกับปัจจัยทางเศรษฐกิจ
...
7. ปัจจัยทางเศรษฐกิจ ได้แก่ ประชากร  GDP และ GDP per capita มีความสัมพันธ์เชิงบวกที่สูงระหว่างกัน ( $${\color{yellowgreen}0.79-1.00}$$  )

![image](figure/fig_heatmap_malaysia.PNG)
<p align="center"> รูปที่ 4 แผนภาพ heatmap แสดงขนาดและทิศทางความสัมพันธ์กันระหว่างปัจจัยต่างๆ ของประเทศมาเลเซีย ด้วยสถิติ Spearman <br>
...
&nbsp;&nbsp;&nbsp;&nbsp;จากแผนภาพ Spearman Correlation Heatmap ของประเทศไทย ผลการวิเคราะห์**ขนาดและทิศทาง**ความสัมพันธ์ในระดับ Group Segment ดังนี้
1. การผลิตรถยนต์โดยรวม (Car Production (All)) มีความสัมพันธ์เชิงบวกที่สูงกับการผลิตรถยนต์นั่งส่วนบุคคล ( $${\color{yellowgreen}0.73}$$  ) และมีความสัมพันธ์เชิงบวกปานกลางกับการผลิต SUV ( $${\color{yellowgreen}0.56}$$  ), รถกระบะ ( $${\color{yellowgreen}0.56}$$  ), และ MPV ( $${\color{yellowgreen}0.59}$$  ) แต่ไม่มีความสัมพันธ์ที่ชัดเจนกับปัจจัยทางเศรษฐกิจ
2. การผลิตรถยนต์นั่งส่วนบุคคล (Car Production (Passenger)) มีความสัมพันธ์เชิงบวกที่สูงกับการผลิต MPV ( $${\color{yellowgreen}0.79}$$  ) มีความสัมพันธ์เชิงลบที่สูงกับประชากร ( $${\color{fuchsia}-0.73}$$  ) และมีความสัมพันธ์เชิงลบปานกลางกับ GDP และ GDP per capita ( $${\color{fuchsia}-0.41}$$  )
3. การผลิตรถ SUV (Car Production (SUV)) มีความสัมพันธ์เชิงบวกที่สูงกับ GDP และ GDP per capita ( $${\color{yellowgreen}0.70}$$  ) มีความสัมพันธ์เชิงบวกที่สูงกับการผลิตรถที่ไม่ได้จำแนกประเภท ( $${\color{yellowgreen}0.66}$$  ) และมีความสัมพันธ์เชิงบวกปานกลางกับประชากร ( $${\color{yellowgreen}0.49}$$  )
4. การผลิตรถกระบะ (Car Production (Pickup)) ไม่มีความสัมพันธ์ที่ชัดเจนกับปัจจัยอื่น ๆ หรือปัจจัยทางเศรษฐกิจ
5. การผลิตรถ MPV (Car Production (MPV)) มีความสัมพันธ์เชิงลบที่สูงมากกับประชากร ( $${\color{fuchsia}-0.88}$$  ) และมีความสัมพันธ์เชิงบวกที่สูงกับการผลิตรถยนต์นั่งส่วนบุคคล ( $${\color{yellowgreen}0.79}$$  ) แต่มีความสัมพันธ์เชิงลบที่สูงกับ GDP และ GDP per capita ( $${\color{fuchsia}-0.72}$$  )
6. การผลิตรถที่ไม่ได้จำแนกประเภท (Car Production (Unclassified)) มีความสัมพันธ์เชิงบวกที่สูงกับประชากร ( $${\color{yellowgreen}0.85}$$  ) GDP ( $${\color{yellowgreen}0.71}$$  ) และ GDP per capita ( $${\color{yellowgreen}0.71}$$  ) แต่มีความสัมพันธ์เชิงลบที่สูงกับการผลิต MPV ( $${\color{fuchsia}-0.62}$$  )
7. ปัจจัยทางเศรษฐกิจ ได้แก่ ประชากร  GDP และ GDP per capita มีความสัมพันธ์เชิงบวกที่สูงระหว่างกัน ( $${\color{yellowgreen}0.72-1.00}$$  )

![image](figure/fig_heatmap_thailand.PNG)
<p align="center"> รูปที่ 5 แผนภาพ heatmap แสดงขนาดและทิศทางความสัมพันธ์กันระหว่างปัจจัยต่างๆ ของประเทศไทย ด้วยสถิติ Spearman <br>
...
### บทสรุป
>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;การศึกษาการผลิตรถยนต์สันดาปจากระดับโลกสู่เอเชียและแต่ละประเทศ สรุปได้ว่า
- **<ins>การเข้าใจเทรนด์ระดับโลก</ins>** เพื่อดูภาพรวมของอุตสาหกรรมยานยนต์ พบว่า ในระดับโลกภูมิภาคเอเชียเป็นผู้ผลิตรถยนต์สันดาปรายใหญ่ที่สุด รถยนต์นั่งส่วนบุคคลมีจำนวนการผลิตสูงสุด แต่ถ้ามองในมุมแนวโน้มจะเห็นสัดส่วนของการผลิตรถยนต์นั่งส่วนบุคคลลดลง ในขณะที่แนวโน้มการผลิตตรถ SUV เพิ่มขึ้นในทุกๆ ปี
- **<ins>เจาะลึกเอเชีย</ins>** เนื่องจากเป็นตลาดที่เติบโตเร็วและมีศักยภาพสูง โดยภูมิภาคเอเชียครองสัดส่วนการผลิต 55% ของโลก นำโดยจีน ญี่ปุ่น และอินเดีย มีการเปลี่ยนแปลงจากรถยนต์นั่งส่วนบุคคลไปสู่รถ SUV
- **<ins>วิเคราะห์รายประเทศ</ins>** โดยดูปัจจัยทางเศรษฐกิจเชื่อมโยงการผลิตกับสภาพเศรษฐกิจ และการแบ่ง Group Segment ของรถยนต์ให้เห็นความแตกต่างในแต่ละประเภทของรถ พบว่า ความสัมพันธ์ระหว่างการผลิตรถยนต์กับปัจจัยทางเศรษฐกิจของแต่ละประเทศแตกต่างกัน โดยรถ SUV จะพบความสัมพันธ์เชิงบวก ส่วนรถยนต์นั่งส่วนบุคคลและรถ MPV มีความสัมพันธ์เชิงลบ และประเทศไทย จะมีลักษณะเฉพาะในการเป็นผู้ผลิตรถกระบะรายใหญ่
>
