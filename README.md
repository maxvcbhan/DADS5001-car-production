...
5. **เกาหลี (Korea)** พบความสัมพันธ์ที่มีนัยสำคัญระหว่างจำนวนการผลิตรถยนต์กับทุกปัจจัย (_p-value < 0.05 ทุกกรณี_) และมีความสัมพันธ์เป็น<code style="color : red">ลบ</code> (_spearman-rho < 0_) แสดงว่าเมื่อปัจจัยเหล่านี้เพิ่มขึ้น ทำให้จำนวนการผลิตรถยนต์มีแนวโน้มลดลง <br>
