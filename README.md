...
2. การผลิตรถยนต์นั่งส่วนบุคคล (Car Production (Passenger)) มีความสัมพันธ์เชิงบวกที่สูงมากกับการผลิต MPV ( $${\color{greenyellow}0.82}$$  ) มีความสัมพันธ์เชิงลบที่สูงมากกับประชากร ( $${\color{red}-0.88}$$  ), GDP ( $${\color{red}-0.81}$$  ) และ GDP per capita ( $${\color{red}-0.81}$$  )
...
4. การผลิตรถกระบะ (Car Production (Pickup)) มีความสัมพันธ์เชิงลบที่ค่อนข้างสูงกับการผลิตรถที่ไม่ได้จำแนกประเภท (Unclassified) ( $${\color{red}-0.77}$$  )
5. การผลิตรถ MPV (Car Production (MPV)) มีความสัมพันธ์เชิงลบที่สูงมากกับประชากร ( $${\color{red}-0.88}$$  ), GDP ( $${\color{red}-0.88}$$  ) และ GDP per capita ( $${\color{red}-0.88}$$  )
